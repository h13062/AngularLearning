...
const routes: Routes = [
  ...
  {
    path: 'delete-interview-feedback',
    component: DeleteInterviewFeedbackComponent,
  },
  { path: 'get-interview-feedback', component: GetInterviewFeedbackComponent },
  {
    path: 'list-interview-feedback',
    component: ListInterviewFeedbackComponent,
  },
  {
    path: 'update-interview-feedback',
    component: UpdateInterviewFeedbackComponent,
  },
];
