...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'interview-type',
        loadChildren: () =>
          import('./interview-type/interview-type.module').then(
            (m) => m.InterviewTypeModule
          ),
      },
      {
        path: 'interview-feedback',
        loadChildren: () =>
          import('./interview-feedback/interview-feedback.module').then(
            (m) => m.InterviewFeedbackModule
          ),
      },
      {
        path: 'recruiter',
