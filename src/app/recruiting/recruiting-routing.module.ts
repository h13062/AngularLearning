...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./job-requirement/job-requirement.module').then(
            (m) => m.JobRequirementModule
          ),
      },
      {
        path: 'submission',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./submission-status/submission-status.module').then(
            (m) => m.SubmissionStatusModule
          ),
      },
    ],
  },
